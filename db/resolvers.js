...
const resolvers = {
    ...
    Mutation: {
        ...
        nuevoCliente: async (_, { input }, ctx) => {
            ...
            const agregarCliente = new Cliente(input)

            // Asignar el vendedor
            agregarCliente.vendedor = ctx.usuario.id;

            try {
                //Guardar en la base de datos
                const resultado = await agregarCliente.save();
                return resultado;
            } catch (error) {
                console.log(error);
            }
